...
%pip install ipython
%wget "https://github.com/igor-davidyuk/openvino_notebooks/tree/main/notebooks/405-paddle-ocr-webcam/pre_post_processing.py"
%wget "https://github.com/igor-davidyuk/openvino_notebooks/tree/main/notebooks/utils/notebook_utils.py"
"""
...
def run_paddle_ocr():
    ...
    file_path = 'D:/intel2_firmware/GitHub/video_sample/G_well.avi'
...
det_model_file_path = Path("D:/intel2_firmware/GitHub/intel_textRecog/work_python/test_openvino/model/ch_PP-OCRv3_det_infer/inference.pdmodel")
rec_model_file_path = Path("D:/intel2_firmware/GitHub/intel_textRecog/work_python/test_openvino/model/ch_PP-OCRv3_rec_infer/inference.pdmodel")
# Download font and a character dictionary for printing OCR results.
font_path = Path("D:/intel2_firmware/GitHub/intel_textRecog/work_python/test_openvino/fonts/simfang.txt")
character_dictionary_path = Path("D:/intel2_firmware/GitHub/intel_textRecog/work_python/test_openvino/fonts/ppocr_keys_v1.txt")
...
rec_compiled_model = core.compile_model(model=rec_model, device_name=device)
